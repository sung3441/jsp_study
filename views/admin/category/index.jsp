            ...
            <div class="card">
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                  	<%for(TopCategoryCount categoryCount : topList){ %>
                    <tr onclick="getSubList(<%=categoryCount.getTopcategory_id() %>);">
                      <td><%= categoryCount.getTop_name() %></td>
                      <td><%= categoryCount.getCnt() %></td>
                    </tr>
              		<%} %>
                  </tbody>
                </table>
