...
%>
<%
	List<ReBoard> reboardList = boardDAO.selectAll();
%>
...
<body>
	<table id="box" align="center" width="603" border="0" cellpadding="0"
		cellspacing="0">
		<tr>
			<td colspan="5"><img src="/reboard/images/ceil.gif" width="603"
				height="25"></td>
		</tr>
		<tr>
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<%for(ReBoard reBoard : reboardList){ %>
						<tr align="center" height="20px"
							...
							<td width="303"><a href="/reboard/detail.jsp?reboard_id=<%=reBoard.getReboard_id()%>"><%= reBoard.getTitle() %></a></td>
						...
						<tr>
							<td height="1" colspan="5"
								background="/reboard/images/line_dot.gif"></td>
						</tr>
					<%} %>
				</table>
			</td>
			...
			<td height="20" colspan="5" align="right" style="padding-right: 2px;">
				<table width="160" border="0" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td><img src="/reboard/images/search_btn.gif" width="32"
							height="17"></td>
					</tr>
				</table>
			</td>
		...
		<tr>
			<td height="30" colspan="5" align="right" style="padding-right: 2px;"><a
				href="write.jsp"><img src="/reboard/images/write_btin.gif"
